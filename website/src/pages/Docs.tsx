...
const DOC_SLUGS: DocEntry[] = [
  ...
  { slug: "agent_md_intro", titleKey: "docs.agentMdIntro" },
  { slug: "local-models", titleKey: "docs.localModels" },
  { slug: "config", titleKey: "docs.config" },
  { slug: "cli", titleKey: "docs.cli" },
  { slug: "tools", titleKey: "docs.tools" },
  { slug: "api", titleKey: "docs.api" },
...
const DOC_TITLES: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "docs.config": "配置与工作目录",
    "docs.commands": "系统命令",
    "docs.agentMdIntro": "Agent Prompt 文件",
    "docs.localModels": "本地模型",
    "docs.tools": "内置工具参考",
    "docs.api": "API 参考",
  ...
  en: {
    ...
    "docs.agentMdIntro": "Agent Prompt Files",
    "docs.localModels": "Local Models",
